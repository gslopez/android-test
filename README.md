...
3.-VersiÃ³n 3.2 de Android instalada
...
en la version de android que se utilizara (3.2). Aqui dejo un tutorial:
...
A continuacion dejo dos tutoriales que explican esto y otras cosas sobre Android.
...
Una vez terminado esto, envien un Pull Request al proyecto en github. Con esto estaran solicitando integrar codigo al proyecto.
...
Asi es como trabajaremos durante el semestre, asi que es una buena manera para practicar.
